...
Route::prefix('ambilbarang')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('stock')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('master/jasabengkel')
    ->middleware($menuAccessMiddleware)
...
Route::prefix('master')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('penjualan')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('approval')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('bengkel')->middleware($menuAccessMiddleware)->group(function () {
    ...
    Route::get('/riwayat', [TransaksiBengkelController::class, 'riwayat'])->name('bengkel.riwayat');
    Route::post('/{id}/cancel', [TransaksiBengkelController::class, 'cancel'])->name('bengkel.cancel');
    Route::get('/{id}/revise', [TransaksiBengkelController::class, 'revise'])->name('bengkel.revise');
    Route::post('/{id}/revise/update', [TransaksiBengkelController::class, 'reviseUpdate'])->name('bengkel.revise.update');
    Route::get('/{id}/cetak', [TransaksiBengkelController::class, 'cetak'])->name('bengkel.cetak');
});
    
Route::prefix('mutasi')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('simpanan')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('users')->middleware($menuAccessMiddleware)->namespace('Users')->group(function () {
    Route::get('/list', [UsersController::class, 'index'])->name('users.list');
    Route::get('/permission', [UserRoleController::class, 'PermissionByRole'])->name('users.permission');
    Route::post('/add', [UserRoleController::class, 'addRole'])->name('users.add');
    Route::delete('/delr', [UserRoleController::class, 'deleteRole'])->name('users.delr');
    Route::delete('/delp', [UserRoleController::class, 'deletePermission'])->name('users.delp');
    ...
    Route::post('/status', [UsersController::class, 'updateStatus'])->name('users.status');
...
Route::prefix('anggota')->middleware($menuAccessMiddleware)->namespace('Anggota')->group(function () {
    ...
    Route::post('/import', [AnggotaController::class, 'importExcel'])->name('anggota.import');
...
Route::prefix('barang')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('barangbengkel')->name('barangbengkel.')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('supplier')->middleware($menuAccessMiddleware)->group(function () {
...
Route::prefix('roles')->middleware($superadminMiddleware)->group(function () {
...
Route::prefix('menu')->middleware($superadminMiddleware)->namespace('menus')->group(function () {
...
Route::prefix('laporan')->middleware($menuAccessMiddleware)->group(function () {
    ...
    Route::get('/kartu-stok/history/{barangId}', [LaporanController::class, 'kartuStokHistoryData'])->name('laporan.kartu_stok.history');
...
Route::prefix('tagihan')->middleware($menuAccessMiddleware)->group(function () {
    // Transaksi
