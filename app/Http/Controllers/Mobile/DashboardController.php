...
class DashboardController extends Controller
{
    ...
    public function ppob()
    {
        ...
        // Cek jika bukan user
        if ($user->ui !== 'user') {
            return redirect()->route('dashboard')->with('warning', 'Anda tidak memiliki akses ke halaman PPOB');
        }

        $drawerMenus = $this->getDrawerMenus($user);

        return view('mobile.ppob.index', compact('user', 'drawerMenus'));
    }
