...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (window.jQuery) {
        ...
        // ini sekarang aman, karena jQuery sudah ada
        $.ajaxSetup({
            headers: {
        ...
        // Color Mode Toggler (kode kamu yang existing)
        (() => {
            "use strict";
        ...
        $(document).ready(function () {
            $('#bdy').addClass('sidebar')
        });
    } else {
        console.error("jQuery belum ter-load saat script ini jalan!");
    }
});
