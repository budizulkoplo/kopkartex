<x-app-layout>
    <x-slot name="pagetitle">Laporan Harian Toko</x-slot>

    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0">Laporan Harian Toko</h3>
                </div>
    ...
    <div class="app-content">
        <div class="container-fluid">
                ...
                <div class="col-md-4">
                    <div class="card card-primary card-outline h-100">
                        <div class="card-body py-3">
                            ...
                            <div class="fs-5 fw-semibold" id="summaryCash">
                ...
                <div class="col-md-4">
                    <div class="card card-warning card-outline h-100">
                        <div class="card-body py-3">
                            ...
                            <div class="fs-5 fw-semibold" id="summaryKredit">
                                Rp {{ number_format($totals['kredit'], 0, ',', '.') }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-info card-outline">
                <div class="card-body">
                    <table id="tbHarianToko" class="table table-sm table-striped table-bordered" style="width: 100%; font-size: small;">
    ...
    <x-slot name="jscustom">
        ...
        <script>
            ...
            function updateSummary(totals) {
                $('#summaryCash').text(formatRupiah(totals.cash));
                $('#summaryKredit').text(formatRupiah(totals.kredit));
            ...
            table = $('#tbHarianToko').DataTable({
                ordering: false,
                responsive: true,
                processing: true,
                pageLength: 31,
                ajax: {
                    url: "{{ route('laporan.harian_toko.data') }}",
                    type: "GET",
                    data: function(d) {
                        d.bulan = $('#bulan').val();
                    },
                ...
                columns: [
                    ...
                    { data: "cash", className: "text-end", render: formatRupiah },
                    { data: "kredit", className: "text-end", render: formatRupiah },
                    { data: "total_penjualan", className: "text-end fw-semibold", render: formatRupiah }
                ],
                footerCallback: function(row, data) {
                    const api = this.api();
                    const columns = ['cash', 'kredit', 'total_penjualan'];
                ...
                buttons: [
                    {
                        ...
                        title: function () {
                            return 'Laporan Harian Toko - ' + $('#bulan').val();
                        },
                        exportOptions: {
                            columns: ':visible'
                        }
